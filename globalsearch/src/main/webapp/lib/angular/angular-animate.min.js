    ...
    g.module("ngAnimate", ["ng"]).factory("$$animateReflow", ["$$rAF", "$document", function (g, G) {
        ...
        H.register("", ["$window", "$sniffer", "$timeout",
            "$$animateReflow", function (h, q, B, L) {
                ...
                var y = "Duration", v = "Property", z = "Delay", p = "IterationCount", w = "$$ngAnimateKey", l = "$$ngAnimateCSS3Data", u = "ng-animate-block-transitions", C = 3, W = 1.5, ca = 1E3, N = {}, da = 0, X = [], S, ea = null, fa = 0, Z = [];
                return {
                    enter: function (a, b) {
